...
- 实现了完整的API数据访问模式
- 新增了内容格式字段（rich/markdown）和页面组件配置
- 改进了数据库配置和迁移机制
...
**章节来源**
- [config.py:14-17](file://company_cms_project/backend/config.py#L14-L17)
- [app/__init__.py:15-48](file://company_cms_project/backend/app/__init__.py#L15-L48)
...
**章节来源**
- [models/post.py:4-280](file://company_cms_project/backend/app/models/post.py#L4-L280)
...
**章节来源**
- [models/post.py:184-280](file://company_cms_project/backend/app/models/post.py#L184-L280)
...
**章节来源**
- [api/posts.py:16-75](file://company_cms_project/backend/app/api/posts.py#L16-L75)
- [api/media.py:35-76](file://company_cms_project/backend/app/api/media.py#L35-L76)
...
**图表来源**
- [models/post.py:173-181](file://company_cms_project/backend/app/models/post.py#L173-L181)
- [models/user.py:21-22](file://company_cms_project/backend/app/models/user.py#L21-L22)
...
**章节来源**
- [config.py:14-17](file://company_cms_project/backend/config.py#L14-L17)
- [app/__init__.py:25-29](file://company_cms_project/backend/app/__init__.py#L25-L29)
...
**章节来源**
- [api/media.py:11-14](file://company_cms_project/backend/app/api/media.py#L11-L14)
...
**章节来源**
- [models/user.py:9-18](file://company_cms_project/backend/app/models/user.py#L9-L18)
- [models/post.py:8-25](file://company_cms_project/backend/app/models/post.py#L8-L25)
- [models/post.py:76-85](file://company_cms_project/backend/app/models/post.py#L76-L85)
- [models/post.py:109-113](file://company_cms_project/backend/app/models/post.py#L109-L113)
- [models/post.py:133-148](file://company_cms_project/backend/app/models/post.py#L133-L148)
- [models/post.py:188-196](file://company_cms_project/backend/app/models/post.py#L188-L196)
- [models/post.py:214-221](file://company_cms_project/backend/app/models/post.py#L214-L221)
...
**图表来源**
- [models/post.py:28-31](file://company_cms_project/backend/app/models/post.py#L28-L31)
- [models/post.py:86-87](file://company_cms_project/backend/app/models/post.py#L86-L87)
- [models/post.py:114-115](file://company_cms_project/backend/app/models/post.py#L114-L115)
- [models/user.py:21-22](file://company_cms_project/backend/app/models/user.py#L21-L22)
...
**章节来源**
- [app/__init__.py:26-27](file://company_cms_project/backend/app/__init__.py#L26-L27)
...
**章节来源**
- [config.py:19-22](file://company_cms_project/backend/config.py#L19-L22)
- [api/posts.py:108-187](file://company_cms_project/backend/app/api/posts.py#L108-L187)

### 技术栈与依赖
- 核心框架：Flask 3.1.2
- 数据库ORM：Flask-SQLAlchemy 3.1.1
- 数据库迁移：Flask-Migrate 4.1.0
- JWT认证：Flask-JWT-Extended 4.7.1
- CORS支持：Flask-CORS 6.0.2
- 环境变量：python-dotenv 1.2.1
- 密码加密：bcrypt 5.0.0
- 图像处理：pillow 11.3.0
- WSGI服务器：waitress 3.0.2, gunicorn 21.2.0

**章节来源**
- [requirements.txt:1-11](file://company_cms_project/backend/requirements.txt#L1-L11)